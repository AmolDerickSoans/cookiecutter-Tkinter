...
class Counter_program():
    def __init__(self):
        self.window = tk.Tk()
        self.window.title('{{cookiecutter.project_name}}')
        self.create_widgets()
...
# "arc  ","plastik" , "adapta" , "yaru" , "radiance" , "breeze" ,"no-theme"
    ...
    def create_widgets(self):
        ...
        button_label = ttk.Label(cmd_frame, text="tk.Button non-themed")
        button_label.grid(row=1, column=1, sticky=tk.W, pady=3)

        button_label = ttk.Label(cmd_frame, text="ttk.Button themed")
    ...
    # - - - - - - - - - - - - - - - - - - - - -
        ...
        listbox_label = ttk.Label(fromlist_frame, text="tk.Listbox")
